...
/// Size of memory td-shim needs to accept when lazy-accept is enabled, 256MiB by default
#[cfg(feature = "lazy-accept")]
pub const TDX_PARTIAL_ACCEPT_MEMORY_SIZE: usize = 0x1000_0000;

/// TD_SHIM_SEC_INFO_OFFSET equals to firmware size(16MiB) - metadata pointer offset(0x20) -
/// OVMF GUID table size(0x28) - SEC Core information size(0xC).
pub const TD_SHIM_SEC_CORE_INFO_OFFSET: u32 = 0xFF_FFAC;
pub const TD_SHIM_SEC_CORE_INFO_BASE: u32 = image::MEMORY_OFFSET + TD_SHIM_SEC_CORE_INFO_OFFSET;

pub const MEMORY_4G: u64 = 0x1_0000_0000;
pub const TD_SHIM_FIRMWARE_BASE: u32 = 0xFF00_0000;
pub const TD_SHIM_FIRMWARE_SIZE: u32 = 0x100_0000;
